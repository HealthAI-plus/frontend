            ...
            <div>
                <div className="flex items-center gap-8">
                    <p className="w-[50%] text-2xl leading-10 text-left">
                        Welcome to HealthAI Plus, where innovation meets healthcare for a smarter, 
                        accessible, and user-friendly medical consultation experience. 
                        HealthAI Plus is a revolutionary AI-powered symptom and diagnosis guidance 
                    ...
                    <div className="w-[50%] text-left flex flex-col gap-10">
                        <div>
                            ...
                            <p className="text-2xl leading-10">
                                At HealthAI Plus, our vision is to bridge the gap between individuals 
