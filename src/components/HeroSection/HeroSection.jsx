...
const HeroSection = () => {
    ...
    const { isLoggedIn, closeChatPopUp, openChatPopUp } = useContext(AuthContext);
        ...
        <section className="flex h-[89dvh] p-2">
            ...
            <div className="h-full flex flex-col justify-center items-center text-[#0F2424]">
                ...
                <div className="flex justify-between w-full font-bold mt-16">
                    ...
                    {/* chat pop up modal */}
                    <div className="flex flex-col justify-center w-[25rem] h-[18rem] gap-10 rounded-lg p-4 absolute bottom-14 right-[30rem] "
